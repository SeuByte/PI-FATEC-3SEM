...
def cadastrar_funcionario(request):
    ...
    if serializer.is_valid():
        ...
        try:
            ...
            FuncionarioService.criar_funcionario(serializer.validated_data)

            return success(message="Funcionário cadastrado com sucesso!", status=201)
...
def atualizar_funcionario(request, id_funcionario):
    ...
    if serializer.is_valid():
        ...
        try:
            ...
            return success(message="Funcionário atualizado com sucesso!")
