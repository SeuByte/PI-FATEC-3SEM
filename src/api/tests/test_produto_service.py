...
class TestProdutoService:
    ...
    def test_service_criar_produto_sucesso(self):
        dados = {
            "Nome": "Feijão Preto",
    ...
    def test_service_atualizar_produto_sucesso(self, produto_db):
        #Cria o dado ficticio
        ...
        # Como o Valor_venda agora é um Decimal do Python, da pra comparar diretamente
        assert produto_db.Valor_venda == Decimal("600.00")
    # Teste de deleção
    def test_service_deletar_produto_sucesso(self, produto_db):
    ...
    def test_service_atualizar_produto_nao_encontrado(self, ):
