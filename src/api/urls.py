...
from src.api.views.produto_views import listar_produtos, listar_produto_id, deletar_produto, editar_produto
...
urlpatterns = [
 ...
 path('deletar_produto/<str:id>/', deletar_produto),
 path('editar_produto/<str:id>/', editar_produto),
